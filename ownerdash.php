							...
							<div class="col-md-12" style="border-right: 1px dotted #C2C2C2;padding-right: 30px; padding-bottom: 20px">
								...
								<form class="form-horizontal" method="post" action="get_data_newbus.php" enctype="multipart/form-data">
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" required class="form-control" name="busname" id="busname" placeholder="Enter name of bus">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="time" required class="form-control" name="dep" id="dep" placeholder="Departure Time">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="time" required class="form-control" name="arr" id="arr" placeholder="Arrival Time">
										</div>
									</div>
									<div class="form-group">
