			...
			<div class="container" id="banner-caption-container" style="margin-top: 0px">
				<div class="row" style="margin-top: 0px">
					<div class="col-md-6 col-md-offset-3 object-non-visible" style="margin-top: 0px" data-animation-effect="fadeIn">
						...
						-->
									<select name="route1" class="inputText" placeholder="Source city"/>
									<?php
									//include( 'db.php' );
					...
					-->
									...
									<select name="route2" class="inputText" placeholder="Source city"/>
									<?php
									//include( 'db.php' );
									$result = mysql_query( "SELECT id,name FROM city" );
									while ( $row = mysql_fetch_array( $result ) ) {
							...
							<div class="row">
								<div class="col-md-6 col-md-offset-3">
									<h2 class="text-center">
											<input type="submit" name= "submit" value="search" class="button" style="z-index: 450; margin-bottom: 270px;">
										</h2>
